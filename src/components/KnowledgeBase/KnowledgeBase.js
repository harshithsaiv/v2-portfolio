        ...
        <div className="space-y-4">
          {filtered.map(post => (
            <Link
              ...
              className="group block border border-gray-800/60 rounded-lg p-6 hover:border-secondary/30 hover:bg-gray-900/20 transition-all duration-300"
            >
              {/* Meta row */}
              ...
              <p className="text-sm text-gray-500 leading-relaxed group-hover:text-gray-400 transition-colors duration-200 overflow-hidden" style={{ display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical' }}>
                {post.body}
              </p>
            </Link>
          ))}
