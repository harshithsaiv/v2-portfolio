    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-3xl mx-auto animate-fade-in">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl lg:text-4xl font-black text-white mb-3">What I'm up to</h1>
          <p className="text-xs font-mono text-gray-600">
            A <a href="https://nownownow.com/about" className="text-secondary hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">/now page</a>
            {' '}— last updated{' '}
        ...
        <div className="space-y-16">
          ...
          <section className="space-y-3">
            <h2 className="text-xs font-mono text-gray-600 tracking-widest mb-6">// reading</h2>
            {books.map((book, index) => (
              <a
                ...
                className="group flex items-center gap-5 border border-gray-800/60 rounded-lg p-4 hover:border-secondary/30 hover:bg-gray-900/20 transition-all duration-300"
              >
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-gray-200 group-hover:text-secondary transition-colors mb-0.5 leading-snug">{book.title}</p>
                  <p className="text-xs font-mono text-gray-600">{book.author}</p>
                </div>
                <div className="flex-shrink-0 w-24 text-right">
                  <div className="text-xs font-mono text-gray-600 mb-1">{book.progress}%</div>
          ...
          <section className="space-y-4">
            <h2 className="text-xs font-mono text-gray-600 tracking-widest mb-6">// learning</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {learningResources.map((resource, index) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-start gap-4 border border-gray-800/60 rounded-lg p-4 hover:border-secondary/30 hover:bg-gray-900/20 transition-all duration-200"
                >
                  <span className="text-2xl flex-shrink-0 mt-0.5">{resource.icon}</span>
                  <div>
                    <p className="text-sm font-mono text-gray-200 group-hover:text-secondary transition-colors mb-1">{resource.title}</p>
          ...
          <section className="space-y-6">
            <h2 className="text-xs font-mono text-gray-600 tracking-widest mb-6">// building</h2>
          ...
          {/* GitHub Activity */}
          <section className="space-y-4">
            <h2 className="text-xs font-mono text-gray-600 tracking-widest mb-6">// github activity</h2>
            <div className="border border-gray-800/60 rounded-lg p-5 overflow-x-auto">
              <img
                src="https://ghchart.rshah.org/64ffda/harshithsaiv"
                alt="Harshith's GitHub contribution graph"
                className="w-full min-w-[600px]"
              />
            </div>
            <div className="flex items-center justify-between">
              <p className="text-xs font-mono text-gray-700">contributions over the past year</p>
              <a
          ...
          <section className="pt-8 border-t border-gray-800/50">
            <p className="text-xs font-mono text-gray-700">
              Inspired by{' '}
              <a href="https://nownownow.com/about" className="text-secondary hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
                the /now movement
              </a>
